...
export class SignupComponent {
  ...
  constructor(private route:Router, public dialog:MatDialog,
    public sharedservice:SharedserviceService ,  private signupService: SignupService, ){}
  ...
  onSubmit(): void {
    this.signupService.signup(this.firstName,this.email,
      this.lastname,this.compname,
      this.desig, this.pswd,this.cpswd,this.mobno 
      )
