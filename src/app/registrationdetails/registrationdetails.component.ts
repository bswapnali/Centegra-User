...
export class RegistrationdetailsComponent {
  addressForm = this.fb.group({
    ...
    AnnualRevenues: [null, Validators.required],
    Registeredaddress: [null, Validators.required],
    address2: null,
    city: [null, Validators.required],
    state: [null, Validators.required],
    CINLLPINFCRN: [null, Validators.required],
    ...
    CompanyNo: [null, Validators.required],
...
companytypelist=[{id:'1',name:'Public Ltd Company'},
{id:'2',name:'Private Ltd Company'},
{id:'3',name:'Unlimited Company'},
{id:'4',name:'Sole Proprietorship'},
{id:'5',name:'Joint Hindu Family Business'},
]
